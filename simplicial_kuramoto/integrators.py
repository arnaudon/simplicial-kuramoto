...
def edge_simplicial_kuramoto(time, phase, simplicial_complex=None, omega_0=None, a=1):
    ...
    return omega_0-(B0.dot(np.sin(B0.T.dot(theta))))-a*B1.T.dot(np.sin(B1.dot(theta)))
...
def integrate_simplicial_kuramoto(
    simplicial_complex, initial_phase, t_max, n_t, omega_0=None, a
):#, weights_e, weights_f):
