...
def edge_simplicial_kuramoto_frustrated(time, phase, simplicial_complex=None, omega_0=None, alpha_1=None, alpha_2=None):
    B0 = simplicial_complex.B0
    W0 = simplicial_complex.W0
    B1 = simplicial_complex.B1
    W1 = simplicial_complex.W1
    ...
    if omega_0 is None:
        omega_0 = np.zeros(2*simplicial_complex.n_edges)
...
def integrate_edge_kuramoto_frustrated(
    simplicial_complex, initial_phase, t_max, n_t, alpha_1=None, alpha_2=None, omega_0=None
): 
    """Integrate the frustrated edge Kuramoto model."""

    rhs = partial(
        edge_simplicial_kuramoto_frustrated, simplicial_complex=simplicial_complex, omega_0=omega_0, alpha_1=alpha_1, alpha_2=alpha_2
    )
    t_eval = np.linspace(0, t_max, n_t)
    opt =  solve_ivp(
        rhs,
